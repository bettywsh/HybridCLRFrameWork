...
public class DemoHelper implements IIdentifierListener {
    ...
    public static final int HELPER_VERSION_CODE = 20250409; // DemoHelper版本号
    ...
    public static final String ASSET_FILE_NAME_CERT = "com.mtgame.com.cert.pem"; // TODO （2）设置 asset证书文件名
