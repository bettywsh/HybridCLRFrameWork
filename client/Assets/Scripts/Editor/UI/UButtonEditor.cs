...
[CustomEditor(typeof(UButton), true)]
[CanEditMultipleObjects]
public class UButtonEditor : SelectableEditor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            m_ScaleTweenInfo.FindPropertyRelative("localScale").vector3Value = new Vector3(0.9f, 0.9f, 0.9f);
