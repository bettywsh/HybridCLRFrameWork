...
namespace cfg
{
public sealed partial class EggRewards : Luban.BeanBase
{
    public EggRewards(JSONNode _buf) 
    {
    ...
    public static EggRewards DeserializeEggRewards(JSONNode _buf)
    {
        return new EggRewards(_buf);
    }
    ...
    public const int __ID__ = -272604289;
